...
if __name__ == "__main__":
    ...
    strategy_options = ["StochRSIMACD", "tripleEMAStochasticRSIATR", "tripleEMA", "breakout", "stochBB", "goldenCross",
                        "candle_wick", "fibMACD", "EMA_cross", "heikin_ashi_ema2", "heikin_ashi_ema", "ema_crossover", "JL ATR + Unusual Volume"]
    strategy = StringVar()
    strategy.set("JL ATR + Unusual Volume")
