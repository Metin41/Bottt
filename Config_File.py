...
strategy = 'JL ATR + Unusual Volume'
TP_SL_choice = 'Custom'
SL_mult = .5
TP_mult = 1
...
symbol = []  ## If Trade_All_Coins is False then we list the coins we want to trade here, otherwise the bot will automatically get all coins and trade them
